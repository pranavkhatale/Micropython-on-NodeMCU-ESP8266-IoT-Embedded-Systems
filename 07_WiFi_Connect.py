...
print('Station Interface activated.')

sta_if.connect('Redmi', 'pranav12345')  # Replace ESSID with the network name, and PASSWORD with the password for the network.

print(sta_if.isconnected())     # Prints (on Terminal) TRUE if connection is established properly.
print('Connection establisehed sucesssfully.')
print('IP address, netmask, gateway, DNS are as follows:')
...
print("Code executed sucessfully check router you'll found this device connected alongwith MAC address")
